...
class RapidGrill_Screen extends StatefulWidget {
  const RapidGrill_Screen({super.key});

  @override
  State<RapidGrill_Screen> createState() => _RapidGrill_ScreenState();
}

class _RapidGrill_ScreenState extends State<RapidGrill_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/roasted-meat-pieces-with-herbs.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
