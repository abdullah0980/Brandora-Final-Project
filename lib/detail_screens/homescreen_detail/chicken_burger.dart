...
class Chicken_Burger extends StatefulWidget {
  const Chicken_Burger({super.key});

  @override
  State<Chicken_Burger> createState() => _Chicken_BurgerState();
}

class _Chicken_BurgerState extends State<Chicken_Burger> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/still-life-delicious-american-hamburger.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
