...
class BurgerTwo_Detail extends StatefulWidget {
  const BurgerTwo_Detail({super.key});

  @override
  State<BurgerTwo_Detail> createState() => _BurgerTwo_DetailState();
}

class _BurgerTwo_DetailState extends State<BurgerTwo_Detail> {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("assets/images/image 39.png"),
                  fit: BoxFit.fill,
                ),
              ),
            ),
