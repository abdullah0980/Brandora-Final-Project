...
class ColdDrink_Screen extends StatefulWidget {
  const ColdDrink_Screen({super.key});

  @override
  State<ColdDrink_Screen> createState() => _ColdDrink_ScreenState();
}

class _ColdDrink_ScreenState extends State<ColdDrink_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/colorful-soda-drinks-macro-shot.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
