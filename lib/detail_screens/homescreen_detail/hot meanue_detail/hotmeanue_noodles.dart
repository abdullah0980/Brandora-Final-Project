...
class HotMeanue_Noodles extends StatefulWidget {
  const HotMeanue_Noodles({super.key});

  @override
  State<HotMeanue_Noodles> createState() => _HotMeanue_NoodlesState();
}

class _HotMeanue_NoodlesState extends State<HotMeanue_Noodles> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/Rectangle 2065.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
