...
class Green_Salaad extends StatefulWidget {
  const Green_Salaad({super.key});

  @override
  State<Green_Salaad> createState() => _Green_SalaadState();
}

class _Green_SalaadState extends State<Green_Salaad> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/Rectangle 2066.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
