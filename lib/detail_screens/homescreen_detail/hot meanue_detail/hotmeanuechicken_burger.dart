...
class HotMeanueChicken_Burger extends StatefulWidget {
  const HotMeanueChicken_Burger({super.key});

  @override
  State<HotMeanueChicken_Burger> createState() => _HotMeanueChicken_BurgerState();
}

class _HotMeanueChicken_BurgerState extends State<HotMeanueChicken_Burger> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/Rectangle 2064.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
