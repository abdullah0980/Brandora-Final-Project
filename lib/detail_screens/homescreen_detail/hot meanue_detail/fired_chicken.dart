...
class FriedChicken_Screen extends StatefulWidget {
  const FriedChicken_Screen({super.key});

  @override
  State<FriedChicken_Screen> createState() => _FriedChicken_ScreenState();
}

class _FriedChicken_ScreenState extends State<FriedChicken_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/Rectangle 2069.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
