...
class SnapSnacks_Screen extends StatefulWidget {
  const SnapSnacks_Screen({super.key});

  @override
  State<SnapSnacks_Screen> createState() => _SnapSnacks_ScreenState();
}

class _SnapSnacks_ScreenState extends State<SnapSnacks_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/pile-salty-snack-bowl-tasty.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
