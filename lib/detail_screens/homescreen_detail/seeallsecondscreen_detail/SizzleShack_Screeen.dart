...
class SizzleShack_Screen extends StatefulWidget {
  const SizzleShack_Screen({super.key});

  @override
  State<SizzleShack_Screen> createState() => _SizzleShack_ScreenState();
}

class _SizzleShack_ScreenState extends State<SizzleShack_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/grilled-sausage.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
