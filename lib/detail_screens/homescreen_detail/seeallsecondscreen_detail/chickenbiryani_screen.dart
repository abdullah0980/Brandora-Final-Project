...
class ChickanBiryani_Screen extends StatefulWidget {
  const ChickanBiryani_Screen({super.key});

  @override
  State<ChickanBiryani_Screen> createState() => _ChickanBiryani_ScreenState();
}

class _ChickanBiryani_ScreenState extends State<ChickanBiryani_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/top-view-pakistan-meal-composition-with-copy-space.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
