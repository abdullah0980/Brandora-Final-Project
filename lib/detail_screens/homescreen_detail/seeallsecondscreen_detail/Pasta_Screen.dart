...
class PastaOne_Screen extends StatefulWidget {
  const PastaOne_Screen({super.key});

  @override
  State<PastaOne_Screen> createState() => _PastaOne_ScreenState();
}

class _PastaOne_ScreenState extends State<PastaOne_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/spaghetti-with-tomato-olives.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
