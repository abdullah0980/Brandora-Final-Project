...
class DashDog_Screen extends StatefulWidget {
  const DashDog_Screen({super.key});

  @override
  State<DashDog_Screen> createState() => _DashDog_ScreenState();
}

class _DashDog_ScreenState extends State<DashDog_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/chocolate-brownie-cake-piece-pie-homemade-pastries-sweet-cooking.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
