...
class Chicken_Screen extends StatefulWidget {
  const Chicken_Screen({super.key});

  @override
  State<Chicken_Screen> createState() => _Chicken_ScreenState();
}

class _Chicken_ScreenState extends State<Chicken_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/fried-chicken-french-fries-black-cement-floor.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
