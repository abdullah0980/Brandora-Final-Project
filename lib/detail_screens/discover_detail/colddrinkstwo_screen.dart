...
class ColdDrinkTwo_Screen extends StatefulWidget {
  const ColdDrinkTwo_Screen({super.key});

  @override
  State<ColdDrinkTwo_Screen> createState() => _ColdDrinkTwo_ScreenState();
}

class _ColdDrinkTwo_ScreenState extends State<ColdDrinkTwo_Screen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/images/pexels-alleksana-4113665.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
