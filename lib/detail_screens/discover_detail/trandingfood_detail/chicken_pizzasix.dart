...
class Chicken_pizzaSix extends StatefulWidget {
  const Chicken_pizzaSix({super.key});

  @override
  State<Chicken_pizzaSix> createState() => _Chicken_pizzaSixState();
}

class _Chicken_pizzaSixState extends State<Chicken_pizzaSix> {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/images/Rectangle 840.png"),
                fit: BoxFit.fill,
              ),
            ),
          ),
