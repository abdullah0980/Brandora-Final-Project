...
class FriedChickenTwo_Screen extends StatefulWidget {
  const FriedChickenTwo_Screen({super.key});

  @override
  State<FriedChickenTwo_Screen> createState() => _FriedChickenTwo_ScreenState();
}

class _FriedChickenTwo_ScreenState extends State<FriedChickenTwo_Screen> {
